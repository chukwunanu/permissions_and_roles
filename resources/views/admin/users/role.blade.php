                    ...
                    <div class="mt-6 p-2">
                        ...
                        <div>
                            ...
                            <ul class="list-disc list-inside">
                                ...
                                <form action="{{ route('admin.users.roles.remove', [$user->id, $user_role->id]) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <x-danger-button type="submit" class="font-medium text-red-600 hover:underline">{{ $user_role->name }}</x-danger-button>
                                </form>
                                @endforeach
                            </ul>
                            @endif
                        ...
                        <div class="max-w-xl">
                            <form action="{{ route('admin.users.roles', $user->id) }}" method="POST" class="space-y-6">
                                @csrf
                                <div class="sm:col-span-4">
                    ...
                    <div class="mt-6 p-2">
                        ...
                        <div>
                            ...
                            <ul class="list-disc list-inside">
                                ...
                                <form action="{{ route('admin.users.permissions.revoke', [$user->id, $user_permission->id]) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <x-danger-button type="submit" class="font-medium text-red-600 hover:underline">{{ $user_permission->name }}</x-danger-button>
                                </form>
                                @endforeach
                            </ul>
                            @endif
                        ...
                        <div class="max-w-xl">
                            <form action="{{ route('admin.users.permissions', $user->id) }}" method="POST" class="space-y-6">
                                @csrf
                                <div class="sm:col-span-4">
                                    <label for="permission" class="block text-sm font-medium text-gray-900">Permissions</label>
                                    <div class="mt-2">
